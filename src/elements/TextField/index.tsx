  ...
  return (
    <div className={`${textFieldStyles} ${className}`}>
      <div className="relative">
        ...
        <div className="relative">
          {startAdornment && (
            <div className={`absolute left-3 top-1/2 -translate-y-1/2 ${adornmentStyles} text-gray-400`}>
              {startAdornment}
            </div>
          )}
          ...
          <input
            ref={ref}
            type={type}
            className={`${inputStyles} ${startAdornment ? 'pl-10' : ''} ${endAdornment ? 'pr-10' : ''}`}
            disabled={disabled}
          ...
          {endAdornment && (
            <div className={`absolute right-3 top-1/2 -translate-y-1/2 ${adornmentStyles} text-gray-400`}>
              {endAdornment}
            </div>
          )}
        </div>
